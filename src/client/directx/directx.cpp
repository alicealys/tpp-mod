...
namespace directx
{
	...
	void disable_d3d11()
	{
		...
		utils::hook::nop(0x140BBC9F0, 5);
		utils::hook::nop(0x140BBC9FE, 5);
		utils::hook::nop(0x140BB9BDE, 3);

		utils::hook::jump(0x141464B04, create_dxgi_factory);
		utils::hook::jump(0x141464B0A, d3d11_create_device);
	}
}
