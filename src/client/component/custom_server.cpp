...
namespace custom_server
{
	namespace
	{
		...
		void patch_win_http()
		{
			utils::hook::nop(SELECT_VALUE(0x141A5CD26, 0x1414AEB26, 0x141A5CE26, 0x1414AE9A6), 6);
			utils::hook::call(SELECT_VALUE(0x141A5CD26, 0x1414AEB26, 0x141A5CE26, 0x1414AE9A6), win_http_set_option_stub);

			utils::hook::nop(SELECT_VALUE(0x141A5CDC8, 0x1414AEBC8, 0x141A5CEC8, 0x1414AEA48), 6);
			utils::hook::call(SELECT_VALUE(0x141A5CDC8, 0x1414AEBC8, 0x141A5CEC8, 0x1414AEA48), win_http_crack_url_stub);
		}
	}
