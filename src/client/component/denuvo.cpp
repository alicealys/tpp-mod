...
namespace denuvo
{
	namespace
	{
		namespace tpp_eng
		{
			...
			{
				static const auto ptr1 = *reinterpret_cast<void**>(0x142B64480);
				static const auto fn1 = 0x140083A30;
				static const auto fn2 = 0x1400F5DE0;
			...
			{
				static const auto fn1 = 0x140356670;
				static const auto fn2 = 0x1403543E0;
				static const auto fn3 = 0x1403542B0;
			...
			{
				static const auto fn1 = 0x14002DAA0;
				static const auto fn2 = 0x1401B5E20;
				static const auto fn3 = 0x1401B5330;
				static const auto ptr1 = *reinterpret_cast<__int64*>(0x142B73290);
			...
			{
				static const auto fn1 = 0x14026EB00;
			...
			{
				static const auto fn1 = 0x140934120;
				static const auto fn2 = 0x140934110;
			...
			{
				static const auto fn1 = 0x14026D350;
			...
			{
				static const auto fn1 = 0x1402624A0;
				static const auto fn2 = 0x140262590;
				static const auto fn3 = set_shadow_range_extra_stub;
				static const auto fn4 = 0x140262620;

				static const auto fn5 = 0x1402624C0;
				static const auto fn6 = set_shadow_bias_stub;
				static const auto fn7 = 0x140262850;

				static const auto fn8 = 0x140262130;
				static const auto fn9 = 0x1402620C0;
				static const auto fn10 = 0x14448CF50;
			...
			void restore_funcs()
			{
				utils::hook::jump(0x14501F770, calculate_muted_effective_volume_stub);          // CAkPBI::CalculateMutedEffectiveVolume
				utils::hook::jump(0x14472D030, vertex_buffer_resource_get_buffer_address_stub); // fox::gr::dg::VertexBufferResourceDx11::GetBufferAddress
				utils::hook::jump(0x148CEEF90, geo_sweep_block_build_bounding_16_stub);         // fox::geo::GeoSweepBlock::BuildBounding16
				utils::hook::jump(0x148552EA0, prefab_list_act_impl_get_interface_stub);        // fox::uix::impl::PrefabListActImpl::GetInterface
				utils::hook::jump(0x147032870, get_lang_text_stub);                             // tpp::ui::utility::GetLangText
				utils::hook::jump(0x148CE07F0, geo_sweep_block_add_data_stub);                  // fox::geo::GeoSweepBlock::AddData
				utils::hook::jump(0x1437A3420, get_default_scene_stub);                         // fox::Scene::GetDefaultScene
				utils::hook::jump(0x144C8DB30, apply_rtpc_value_stub);                          // CAkRTPCMgr::AkRTPCEntry::ApplyRTPCValue
				utils::hook::jump(0x143B294F0, scene_dequeue_stub);                             // fox::gr::Scene::Dequeue
				utils::hook::jump(0x1444AAFE0, set_shadow_range_extra_stub);                    // fox::gr::DirectionalLightSource::SetShadowRangeExtra
				utils::hook::jump(0x1469B4E10, is_end_loading_tips_stub);	                    // tpp::ui::hud::CommonDataManager::IsEndLoadingTips
				utils::hook::jump(0x146512620, update_gr_directional_light_shadow_params_stub); // tpp::ef::atmosphere::impl::DirectionalLightController::UpdateGrDirectionalLightShadowParameters
			}
		}
		...
		void restore_funcs()
		{
			...
			{
			case game::environment::mode_tpp_eng:
				tpp_eng::restore_funcs();
				break;
			}
		}
	}
