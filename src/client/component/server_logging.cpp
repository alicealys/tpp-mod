...
namespace server_logging
{
	namespace
	{
		...
		void session_daemon_update_stub(utils::hook::assembler& a)
		{
			...
			a.xor_(esi, esi);
			a.comiss(xmm6, xmm0);
			a.jmp(SELECT_VALUE(0x1407DFC0E, 0x14057D1BE, 0x1407DED0E, 0x14057CB8E));
		}
		...
		void net_daemon_set_heartbeat(void* this_, int value)
		{
			...
			utils::hook::invoke<void>(SELECT_VALUE(0x1407DE720, 0x14057BC90, 0x1407DD820, 0x14057B660), this_, value);
		}
	}
	...
	public:
		...
		void start() override
		{
			...
			utils::hook::far_jump<BASE_ADDRESS>(SELECT_VALUE(0x1407DFC08, 0x14057D1B8, 0x1407DED08, 0x14057CB88), utils::hook::assemble(session_daemon_update_stub));
			utils::hook::call(SELECT_VALUE(0x1407D2736, 0x144DA6856, 0x1407D16B6, 0x14651E946), net_daemon_set_heartbeat);
		}
	};
}
