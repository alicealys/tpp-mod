...
namespace scripting
{
	...
	public:
		...
		void start() override
		{
			utils::hook::inject(SELECT_VALUE(0x14017A357, 0x142EF23D6, 0x14359C6C6, 0x142E1C046) + 3, lua_print<console::con_type_info>);
			utils::hook::inject(SELECT_VALUE(0x14017A37A, 0x142EF23F9, 0x14359C6E9, 0x142E1C069) + 3, lua_print<console::con_type_warning>);
			utils::hook::inject(SELECT_VALUE(0x14017A39D, 0x142EF241C, 0x14359C70C, 0x142E1C08C) + 3, lua_print<console::con_type_warning>);
			utils::hook::inject(SELECT_VALUE(0x14017A3C0, 0x142EF243F, 0x14359C72F, 0x142E1C0AF) + 3, lua_print<console::con_type_error>);
