...
namespace scripting
{
	...
	public:
		...
		void start() override
		{
			utils::hook::inject(SELECT_VALUE(0x14017A357, 0x14017CD87, 0x0, 0x0) + 3, lua_print<console::con_type_info>);
			utils::hook::inject(SELECT_VALUE(0x14017A37A, 0x14017CDAA, 0x0, 0x0) + 3, lua_print<console::con_type_warning>);
