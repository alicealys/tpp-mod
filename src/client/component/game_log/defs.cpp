...
namespace game_log
{
	...
	public:
		void pre_load() override
		{
			...
			var_game_log_width = vars::register_int("game_log_width", 
				50, 0, 1000, vars::var_flag_saved, "game log width");

			var_game_log_max_message_len = vars::register_int("game_log_message_max_len", 64, 0, 
