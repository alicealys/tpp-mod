...
namespace hashes
{
	...
	public:
		...
		void start() override
		{
			...
			fox_str_hash_hook.create(SELECT_VALUE(0x1400234E0, 0x140022F00, 0x0, 0x0), fox_str_hash_stub);
			shared_string_to_string_id_hook.create(SELECT_VALUE(0x14001D630, 0x14006E4C0, 0x0, 0x0), shared_string_to_string_id_stub);
